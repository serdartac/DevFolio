...
namespace DevFolio.Models
{
    ...
    public partial class DbDevFolioEntities : DbContext
    {
        ...
        public virtual ObjectResult<LastReadMessage_Result> LastReadMessage()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<LastReadMessage_Result>("LastReadMessage");
        }
    
        public virtual ObjectResult<Nullable<int>> UnreadMessageCount()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<int>>("UnreadMessageCount");
        }
    }
}
